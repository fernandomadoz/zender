          ...
          <div class="box">
            <div class="box-header">
              ...
              <p class="bg-info">
                ...
                <?php echo __('Envio 4: ') ?> @{{ cant_envio_4 }} | 
                <?php echo __('Envio 5: ') ?> @{{ cant_envio_5 }} 
              </p>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tr>
                  ...
                  <?php foreach ($campos as $campo) { ?>
                    <td>
                      ...
                      <div class="pull-left">
                        <label class="switch">
                          <input type="checkbox" v-model="show_col_<?php echo $campo[0] ?>">
                          <span class="slider round"></span>
                        </label>
                      </div>                  
                    </td>
              ...
              <table id="table" class="table table-bordered table-striped" style="max-width: 500px" >
                  <thead>
                      <tr>
                          ...
                          <?php foreach ($campos as $campo) { ?>
                            <th v-show="show_col_<?php echo $campo[0] ?>"><?php echo $campo[1] ?></th>
                          <?php } ?>
                  ...
                  <tbody>
                    ...
                    foreach ($Contactos as $Contacto) { 
                      ...
                      foreach ($campos as $campo) {
                        ...
                        $url_whatsapp_1 = $ListasController->url_whatsapp($Lista_de_envio->mensaje_1, $parametros, $campos);
                        $url_whatsapp_2 = $ListasController->url_whatsapp($Lista_de_envio->mensaje_2, $parametros, $campos);
                        $url_whatsapp_3 = $ListasController->url_whatsapp($Lista_de_envio->mensaje_3, $parametros, $campos);
                        $url_whatsapp_4 = $ListasController->url_whatsapp($Lista_de_envio->mensaje_4, $parametros, $campos);
                        $url_whatsapp_5 = $ListasController->url_whatsapp($Lista_de_envio->mensaje_5, $parametros, $campos);
                      ...
                      ?>
                        ...
                        <tr>
                            ...
                            <?php foreach ($campos as $campo) { ?>
                              <td v-show="show_col_<?php echo $campo[0] ?>">
                                <?php  
                                  $nombre = $campo[0];
                            ...
                            <td v-show="mensaje_extra != ''">
                              ...
                              <!-- ENVIO DE MENSAJE EXTRA x WHATSAPP -->             
                                  <a v-bind:href="url_mensa_extra('<?php echo $ListasController->celular_wa($Contacto->telefono, $Contacto->codigo_tel) ?>')" target="_blank">
                                  ...
                                  <a v-show="enviar_mail" data-toggle="modal" data-target="#modal-confirmar-mail" v-on:click="preparar_envio_mail(1, '', '', <?php echo $Contacto->id ?>, '<?php echo __('Mensaje Extra') ?>', <?php echo $i ?>)">
        ...
        <script type="text/javascript">
            ...
            var app = new Vue({
              ...
              data: {
                ...
                <?php foreach ($campos as $campo) { ?>
                  show_col_<?php echo $campo[0] ?>: false,
                <?php } ?>  
                mensaje_extra: '',
                email_nombre: null,
                email_apellido: null,
              ...
              computed: {
                ...
                cant_envio_4: function () {
                 cant = this.contar_cant_inscriptos('envio_4')
                 return cant
                },

                
                cant_envio_5: function () {
                 cant = this.contar_cant_inscriptos('envio_5')
                 return cant
                },
