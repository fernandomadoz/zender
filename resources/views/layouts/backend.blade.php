...
<head>
  ...
  <title>Zender | <?php echo __('Solicitudes de Campañas') ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-send-o"></i> Zender</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{{ Auth::user()->name }}}</p>
          <a href="#"> <?php echo Auth::user()->empresa->empresa ?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo env('PATH_PUBLIC')?>crear-campania"><i class="fa fa-circle-thin"></i> <span><?php echo __('Crear Campaña') ?></span></a></li> 
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Contacto_<?php echo Auth::user()->empresa->prefijo ?>/0"><i class="fa fa-circle-thin"></i> <span><?php echo __('Contactos') ?></span></a></li> 
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Encabezado_de_envio/6"><i class="fa fa-circle-thin"></i> <span>Encabezados de envio</span></a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Lista_de_envio/0"><i class="fa fa-circle-thin"></i> <span>Listas de envio</span></a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Instancia_de_envio/0"><i class="fa fa-circle-thin"></i> <span>Instancias de envio</span></a></li>   
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <?php if (Auth::user()->empresa->prefijo == 'mig' or in_array($rol_de_usuario_id, $permiso_administrador)) { ?>
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Origen_mig/0"><i class="fa fa-circle-thin"></i> Origenes</a></li> 
            <?php } ?>
            <?php if (Auth::user()->empresa->prefijo == 'tyt' or in_array($rol_de_usuario_id, $permiso_administrador)) { ?>
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Tipo_de_negocio_tyt/0"><i class="fa fa-circle-thin"></i> Tipos de Negocio</a></li> 
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Nivel_de_compra_tyt/0"><i class="fa fa-circle-thin"></i> Niveles de compra</a></li> 
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Regimen_de_visita_tyt/0"><i class="fa fa-circle-thin"></i> Regimenes de Negocio</a></li> 
            <?php } ?>
            <?php if (in_array($rol_de_usuario_id, $permiso_administrador)) { ?>
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Tipo_de_lista_de_envio/0"><i class="fa fa-circle-thin"></i> <span>Tipos de Listas de envio</span></a></li>  
              ...
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Empresa/0"><i class="fa fa-circle-thin"></i> Empresas</a></li> 
