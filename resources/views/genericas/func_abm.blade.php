...
<script src="<?php echo env('PATH_PUBLIC')?>bower_components/ckeditor5/ckeditor.js"></script>

<!-- Spectrum -->
<link rel="stylesheet" type="text/css" href="<?php echo env('PATH_PUBLIC')?>js/bgrins-spectrum/spectrum.css">
<script src="<?php echo env('PATH_PUBLIC')?>js/bgrins-spectrum/spectrum.js"></script>
